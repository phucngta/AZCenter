...
class profile extends Public_Controller
{
	...
	public function index()
	{
		...
		$the_view ='templates/public/_parts/profile_content_view.php';
		$this->data['profile_content'] = (is_null($the_view)) ? '' : $this->load->view($the_view,$this->data, TRUE);;
		$this->render("templates/public/profile_master_view.php");
	}
}